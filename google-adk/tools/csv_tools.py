...
import pandas as pd
import datetime
from typing import Dict, List, Any  # Optional/ToolContext removed – not used

from google.adk.tools import FunctionTool  # ToolContext import was unused and removed
